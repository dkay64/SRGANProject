...
# Load first n images (to train on a subset of all images)
n=5000
# Note: [IMPORTANT] Modify n accordingly based on the total and/or desired number of images (to be trained on)
...
epochs = 10 #Modify accordingly i.e., 10 epochs (the more the better)
